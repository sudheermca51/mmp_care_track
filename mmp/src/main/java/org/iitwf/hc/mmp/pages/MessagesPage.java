...
public class MessagesPage {
	...
	public HashMap<String, String> sendMessageToAdmin(String patientName, String message) {
		...
		driver.findElement(By.id("subject")).sendKeys("Visit_Reminder"+RandomUtils.generateRandomString(5));
		expectedHMap.put("subject", driver.findElement(By.id("subject")).getDomProperty("value"));
		driver.findElement(By.id("message")).sendKeys("Appointment Reminder: " + message);
